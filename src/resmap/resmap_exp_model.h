...
#include "../../src_tools/debug.h"
#include "../../src_tools/checker.h"
...
public:
	...
	//
	void setScaleCorrectionBoundary(const int* _Mresol_fine,const VectorOfArray2d<FDOUBLE>& data_vs_prior_class);
...
#pragma omp critical
    ...
    void unitTest();
private:
    void shiftOneFimageByXYabTable(	const FDOUBLE* Fimgs_in_real,const FDOUBLE* Fimgs_in_imag,
