...
public:
    Vol(){}
    Vol(size_t _dimz,size_t _dimy,size_t _dimx,bool _inHBM = false){init_zero(_dimz,_dimy,_dimx,_inHBM);}
    void init_zero(size_t _dimz,size_t _dimy,size_t _dimx,bool _inHBM = false){
    ...
    void init_nonzero(size_t _dimz,size_t _dimy,size_t _dimx,bool _inHBM = false){
        this->dimx = _dimx;this->dimy = _dimy;this->dimz = _dimz;
        this->dimyx = _dimy*_dimx;this->dimzyx = _dimz*_dimy*_dimx;
        this->inHBM = _inHBM;
        this->ptr = (T*)allocMemory(sizeof(T)*_dimx*_dimy*_dimz, 64, this->inHBM, __FILE__, __LINE__);
    ...
    void fill_zero(){memset(this->ptr, 0, sizeof(T)*this->dimzyx);}
...
public:
    ...
    void fill_zero(){memset(this->ptr, 0, sizeof(MKL_Complex16)*this->dimzyx);/*MKL_Complex16 v;v.real = v.imag = 0;fill(v);*/}
