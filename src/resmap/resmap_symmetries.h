...
/* SYMMETRIES                                                                */
/* ------------------------------------------------------------------------- */
#ifndef SYMMETRIES_H_
#define SYMMETRIES_H_
...
public:
    ...
    /** Get matrices from the symmetry list.
        ...
        @endcode */
    void get_matrices(int i, Matrix2D<FDOUBLE> &L, Matrix2D<FDOUBLE> &R) const;
    ...
    /** Set a couple of matrices in the symmetry list.
        ...
        @endcode */
    void set_matrices(int i, const Matrix2D<FDOUBLE> &L, const Matrix2D<FDOUBLE> &R);
    ...
    void add_matrices(const Matrix2D<FDOUBLE> &L, const Matrix2D<FDOUBLE> &R,
                      int chain_length);
    ...
    */
    FDOUBLE  non_redundant_ewald_sphere(int pgGroup, int pgOrder);
};


// Symmetrise a 3D map according to the specified symmetry
// void symmetriseMap(MultidimArray<FDOUBLE> &img, FileName &fn_sym, bool do_wrap = false);

//@}
#endif /* defined(SYMMETRIES_H_) */
