...
#undef ELT
    ...
    void HiddenVariableMonitor::bcastData(int bcastNode)
    {
        ...
        MPI::COMM_WORLD.Bcast(&smallest_changes_optimal_classes, 1, MPI::DOUBLE, bcastNode);
...
#undef CINMETADATASTR
    ...
    void gatherMetaDataToMaster(MetaDataTable& metadata,int masterNode,bool do_split_random_halves)
    {
